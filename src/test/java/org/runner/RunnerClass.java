...
@RunWith(Suite.class)
@SuiteClasses({TC01_BrowserLaunch.class
		,TC02_LoginPage.class,
		TC03_FictionBooksPage.class,
		TC04_BiharDiariesPage.class,
		TC05_AgainFictionBooksPage.class,
		TC06_CartPage.class,
		TC07_ShipingPage.class,
